...
<body>
    <div class="addStaff-container">
        ...
        <h1 style="text-align: center; margin-top: 3em;">Edit Staff Data</h1>
        <form class="m-5" action="/updateStaff/{{$staff->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Staff Name</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="name" value="{{$staff->name}}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control" id="exampleInputEmail1" name="age" value="{{$staff->age}}">
                @error('age')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="address" value="{{$staff->address}}">
                @error('address')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="exampleInputEmail1" name="number" value="{{$staff->number}}">
                @error('number')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="position" value="{{$staff->position}}">
                @error('position')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
