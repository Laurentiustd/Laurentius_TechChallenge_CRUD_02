...
<body>
    ...
    <h1 style="text-align: center; margin-top: 3em;">About Us</h1>
    <div class="about-container">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
                <h5 class="card-title">2020</h5>
                <p class="card-text">enjoy site template with powerfull script installer, site development tools& much more!</p>
